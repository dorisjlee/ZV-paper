...
\abstract{
\change{Visual query systems (VQSs) empower users to interactively search for line charts with desired visual patterns typically specified using intuitive sketch-based interfaces. Despite decades of past work on VQSs, these efforts have not translated to adoption in practice\achange{, often because VQSs are evaluated in unrealistic lab-based settings. To remedy this, we performed a year-long particpatory design with experts from three diverse domains---astronomy, genetics, and material science---to develop a VQS to support their workflow and analytical needs,} and evaluate how VQSs are used in practice. Our study results reveal that ad-hoc sketch-based querying is not as commonly used as prior work suggests, since analysts are often unable to precisely express their patterns of interest. In addition, \achange{we characterize three essential sensemaking processes supported by our enhanced VQS. We discover that experts from all domains employ all three processes, but in different proportions, depending on the analytical needs in each domain. Our findings point to the need for integrating all three sensemaking processes into the design of future VQSs to make them useful and practical, by addressing a wide range of analytical inquiries.}}
}
