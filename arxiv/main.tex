...
\newcommand{\fchange}[1]{{\leavevmode#1}}
...
\author[D. Lee, J. Lee, T. Siddiqui, J. Kim, K. Karahalios, A. Parameswaran]{Doris Jung-Lin Lee, John Lee, Tarique Siddiqui, Jaewoo Kim, Karrie Karahalios, Aditya Parameswaran
\vspace{-10pt}
 \\University of Illinois, Urbana-Champaign
 \\ \{jlee782, lee98, tsiddiq2, jkim475, kkarahal, adityagp\}@illinois.edu
}
...
% }
% \email{{jlee782, lee98, tsiddiq2, jkim475, kkarahal, adityagp}@illinois.edu}
...
\input{04-pd-system-findings}
\input{05-pd-sensemaking}
\input{06-discussion}
\input{07-conclusion}
\newpage
