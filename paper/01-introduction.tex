...
{\em Our paper seeks to bridge this gap between current research on VQSs \tvcg{to understand why existing VQSs are commonly used by analysts} and how they can actually be used in practice, as a first step towards the broad adoption of VQSs in data analysis}. 
...
that, similar to existing VQSs~\cite{wattenberg2001sketching}, allowed users to search for desired trends via drawing on a canvas.}
