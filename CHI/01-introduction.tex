...
Two-dimensional line charts are one of the most ubiquitous visualization types, due to its intuitive nature simple attractive visually portraying trends, patterns , etc,underlying complex physical process.%, not only for time series but also for understanding the relationships between multiple measures variables.
