...
we worked closely with them to develop features to address their problems and challenges. \change{In this section, we will first introduce a taxonomy for organizing these components into}
...
\boldpara{View specification} settings 
...
\subsection{Characterizing the Design Space for VQSs}
