...
for context creation\agp{how did you get these stats? explain how you derived "useful for X\%"}. 
\change{In this section, we highlight 
...
do not simply follow a linear progression, going from unknown to known pattern instance and visualized attributes in the problem space \agp{maybe point to figure?}. 
...
for addressing a wide range of analytical inquiries.%single-directional 
