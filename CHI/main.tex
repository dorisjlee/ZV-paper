...
\def\plaintitle{{\em You can't always sketch what you want}: \\ Understanding Sensemaking in Visual Query Systems}
\def\emptyauthor{}
\def\plainkeywords{Visual analytics, visualization, exploratory data analysis, visual query.}
...
\end{abstract}
\keywords{Visual analytics, visualization, exploratory data analysis, visual query.}
