...
about the visualized attribute and pattern instance.%, as shown in Figure~\ref{2dmodel}.
...
\boldpara{Top-down Pattern Specification} 
...
of visual sensemaking: \textit{which pattern instance exhibits this pattern?}%, effectively moving rightwards to the gray area in Figure~\ref{2dmodel}, where the pattern instance is known. 
