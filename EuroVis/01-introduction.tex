...
\begin{figure}[ht!]
	...
	\vspace{-6pt}\caption{\change{Desired insights, problem and dataset challenges for each application domain.}}
	\label{timeline}
	\vspace{-10pt}
\end{figure}
...
\agp{Expand on evaluation study findings. Argue for why we studied multiple domains (which is not typical) and the challenges in doing so.}
