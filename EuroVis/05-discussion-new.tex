...
by the system, and use of external tools\change{, detailed in Appendix~\ref{apdx:studydetails}}.
% \begin{denselist}
...
\subsection{The Sensemaking Process in \change{VQS Workflows}}
...
Using the taxonomy in \change{Section~\ref{sec:pd_findings}},%Figure~\ref{fig:taxonomy},
...
when the transition model has evolved to a steady state\change{~\cite{pierre2011}}.
...
of the analytic challenges associated with their subject area\change{, described in Section~\ref{sec:pd_findings}}.
