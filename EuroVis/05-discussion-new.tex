...
repressed genes (\change{starting high then decreasing}),
and transients (\change{rising first then dropping} at different time points). The clusters provoked G2 to generate a hypothesis
